...
class DatabaseQueryAgent(Agent):
    ...
    def __init__(self, model: BaseLanguageModel, tool: ExecuteQueryTool):
        ...
        Your first message should contain a list of steps that you will follow to retrieve the necessary data or
...
class HTMLGeneratorAgent(Agent):
    ...
    def __init__(self, model: BaseLanguageModel, tool: PythonREPLTool):
        ...
        Your first message should contain a description of the UI elements that you will generate to format the
        response for the user (layout, tables, charts, etc.).
